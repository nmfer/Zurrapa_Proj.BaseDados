  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new BranchEmployee.Data.XlsDataContractSerializerOutputFormatter());
          ...
          options.OutputFormatters.Add(new BranchEmployee.Data.CsvDataContractSerializerOutputFormatter());
